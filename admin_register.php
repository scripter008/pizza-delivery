...
if(isset($_POST['register'])){
   ...
   if($select_admin->rowCount() > 0){
      $message[] = 'Օգտանունն արդեն գոյություն ունի!';
   }else{
      if($pass != $cpass){
         ...
         $message[] = 'Նոր ադմինը հաջողությամբ գրանցվեց!';
      }
   }
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="cpass" required placeholder="հաստատեք ձեր գաղտնաբառը" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
