...
<head>
   ...
   <title>Օգտվողների հաշիվներ</title>
...
<section class="accounts">
   ...
   <h1 class="heading">Օգտվողի հաշիվ</h1>
   ...
   <div class="box">
      ...
      <p> էլփոստ . <span><?= $fetch_accounts['email']; ?></span> </p>
      <a href="users_accounts.php?delete=<?= $fetch_accounts['id']; ?>" onclick="return confirm('delete this account?')" class="delete-btn">Հեռացնել</a>
   </div>
   <?php
         }
      }else{
